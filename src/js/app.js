...
const playlist = [
  { titulo: "Capa do Álbum", caminho: "src/media/hino1.mp3", capa: "src/imagens/melodias-da-alma.jpeg"},
  ...
  { titulo: "Hino 10 - Pelo Sangue purificado", caminho: "src/media/hino10.mp3", capa: "src/imagens/img10.jpeg" }
];
